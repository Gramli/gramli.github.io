---
layout: post
title: ".NET Reflection Performance: CSV Export Benchmarks (Part 2)"
date: 2026-04-21
categories: [dotnet, benchmark, performance, reflection, csharp, export, csv]
description: "Benchmarking reflection-based, cached reflection, and dictionary-based approaches for CSV data export in .NET 10."
canonical_url: "https://dev.to/gramli/net-reflection-performance-csv-export-benchmarks-part-2-5aja"
---
